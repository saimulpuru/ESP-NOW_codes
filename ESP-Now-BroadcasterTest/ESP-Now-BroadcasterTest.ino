//Code for multiple ESP32 to act the same way, by using commands from any ESP32 in the network. 
//No need for Mac address. Every ESP32 Mac STA specified with 0xFF will work the same way
//Serial monitor connected to any of these ESP32s, should output the MAC ADDRESS: STATUS OF BUTTON from that ESP32 as on or off
//Author: Sai Mulpuru
